...
// rattata collide
  ...
  rattata1.debug = true;
  rattata1.setCollider("rectangle",20,10,160,160);
  rattata2.collide(ground3);
  rattata2.debug = true;
  rattata2.setCollider("rectangle",20,10,160,160);
  rattata3.collide(ground3);
  rattata3.debug = true;
  rattata3.setCollider("rectangle",20,10,160,160);
  rattata4.collide(ground4);
  rattata4.debug = true;
  rattata4.setCollider("rectangle",20,10,160,160);
  rattata5.collide(ground4);
  rattata5.debug = true;
  rattata5.setCollider("rectangle",20,10,160,160);
  rattata6.collide(ground5);
  rattata6.debug = true;
  rattata6.setCollider("rectangle",20,10,160,160);
  rattata7.collide(ground5);
  rattata7.debug = true;
  rattata7.setCollider("rectangle",20,10,160,160);
